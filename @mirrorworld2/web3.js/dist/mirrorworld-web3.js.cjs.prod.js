...
exports.ClusterEnvironment = void 0;
...
})(exports.ClusterEnvironment || (exports.ClusterEnvironment = {}));
...
var MirrorWorldAPIClient = /*#__PURE__*/function () {
  function MirrorWorldAPIClient(_ref) {
    var _ref$env = _ref.env,
        env = _ref$env === void 0 ? exports.ClusterEnvironment.mainnet : _ref$env,
        apiKey = _ref.apiKey,
    ...
    this.sso = axios__default['default'].create({
      withCredentials: true,
...
function createAPIClient(_ref2) {
  ...
  var environment = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : exports.ClusterEnvironment.mainnet;
...
var clientOptionsSchema = joi__default['default'].object({
  env: joi__default['default'].string().optional().valid(exports.ClusterEnvironment.mainnet, exports.ClusterEnvironment.testnet, exports.ClusterEnvironment.local),
  apiKey: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_OPTIONS', toErrorMessage('INVALID_OPTIONS', '`apiKey` is required'))),
  autoLoginCredentials: joi__default['default'].string().optional().error(MirrorWorldSDKError["new"]('INVALID_OPTIONS', toErrorMessage('INVALID_OPTIONS', '`autoLoginCredentials` should be a string.'))),
  staging: joi__default['default']["boolean"]().optional().error(MirrorWorldSDKError["new"]('INVALID_OPTIONS', toErrorMessage('INVALID_OPTIONS', '`staging` should be a boolean.')))
});
...
var transferSOLSchema = joi__default['default'].object({
  to_publickey: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_TRANSFER_SPL_TOKEN_PAYLOAD', toErrorMessage('INVALID_TRANSFER_SPL_TOKEN_PAYLOAD', '`to_publickey` should be a valid public key'))),
  amount: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_TRANSFER_SPL_TOKEN_PAYLOAD', toErrorMessage('INVALID_TRANSFER_SPL_TOKEN_PAYLOAD', '`amount` should be a valid number')))
});
var transferSPLTokenSchema = joi__default['default'].object({
  to_publickey: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_TRANSFER_SPL_TOKEN_PAYLOAD', toErrorMessage('INVALID_TRANSFER_SPL_TOKEN_PAYLOAD', '`to_publickey` should be a valid public key'))),
  decimals: joi__default['default'].number().required().integer().error(MirrorWorldSDKError["new"]('INVALID_TRANSFER_SPL_TOKEN_PAYLOAD', toErrorMessage('INVALID_TRANSFER_SPL_TOKEN_PAYLOAD', '`decimals` should be a valid integer'))),
  amount: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_TRANSFER_SPL_TOKEN_PAYLOAD', toErrorMessage('INVALID_TRANSFER_SPL_TOKEN_PAYLOAD', '`amount` should be a valid number'))),
  token_mint: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_TRANSFER_SPL_TOKEN_PAYLOAD', toErrorMessage('INVALID_TRANSFER_SPL_TOKEN_PAYLOAD', '`token_mint` should be a valid address')))
});

var createVerifiedCollectionSchema = joi__default['default'].object({
  name: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_CREATE_VERIFIED_COLLECTION_PAYLOAD', toErrorMessage('INVALID_CREATE_VERIFIED_COLLECTION_PAYLOAD', '`name` should be a valid string'))),
  symbol: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_CREATE_VERIFIED_COLLECTION_PAYLOAD', toErrorMessage('INVALID_CREATE_VERIFIED_COLLECTION_PAYLOAD', '`symbol` should be a valid string of less than 10 characters'))),
  confirmation: joi__default['default'].string().valid('confirmed', 'finalized').optional().error(MirrorWorldSDKError["new"]('INVALID_CREATE_VERIFIED_COLLECTION_PAYLOAD', toErrorMessage('INVALID_CREATE_VERIFIED_COLLECTION_PAYLOAD', '`commitment` should be one of "confirmed" or "finalized"'))),
  url: joi__default['default'].string().uri().required().error(MirrorWorldSDKError["new"]('INVALID_CREATE_VERIFIED_COLLECTION_PAYLOAD', toErrorMessage('INVALID_CREATE_VERIFIED_COLLECTION_PAYLOAD', '`metadata uri` should be a valid url')))
});
joi__default['default'].object({
  collection_mint: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_CREATE_VERIFIED_SUB_COLLECTION_PAYLOAD', toErrorMessage('INVALID_CREATE_VERIFIED_SUB_COLLECTION_PAYLOAD', '`parentCollection` should be a valid mint address'))),
  name: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_CREATE_VERIFIED_SUB_COLLECTION_PAYLOAD', toErrorMessage('INVALID_CREATE_VERIFIED_SUB_COLLECTION_PAYLOAD', '`name` should be a valid string'))),
  symbol: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_CREATE_VERIFIED_SUB_COLLECTION_PAYLOAD', toErrorMessage('INVALID_CREATE_VERIFIED_SUB_COLLECTION_PAYLOAD', '`symbol` should be a valid string of less than 10 characters'))),
  url: joi__default['default'].string().uri().required().error(MirrorWorldSDKError["new"]('INVALID_CREATE_VERIFIED_SUB_COLLECTION_PAYLOAD', toErrorMessage('INVALID_CREATE_VERIFIED_SUB_COLLECTION_PAYLOAD', '`metadataUri` should be a valid url'))),
  confirmation: joi__default['default'].string().valid('confirmed', 'finalized').optional().error(MirrorWorldSDKError["new"]('INVALID_CREATE_VERIFIED_COLLECTION_PAYLOAD', toErrorMessage('INVALID_CREATE_VERIFIED_COLLECTION_PAYLOAD', '`commitment` should be one of "confirmed" or "finalized"')))
});
var mintNFTSchema = joi__default['default'].object({
  collection_mint: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_MINT_NFT_PAYLOAD', toErrorMessage('INVALID_MINT_NFT_PAYLOAD', '`collection` should be a valid collection address'))),
  name: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_MINT_NFT_PAYLOAD', toErrorMessage('INVALID_MINT_NFT_PAYLOAD', '`name` should be a valid string'))),
  symbol: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_MINT_NFT_PAYLOAD', toErrorMessage('INVALID_MINT_NFT_PAYLOAD', '`symbol` should be a valid string of less than 10 characters'))),
  url: joi__default['default'].string().uri().required().error(MirrorWorldSDKError["new"]('INVALID_MINT_NFT_PAYLOAD', toErrorMessage('INVALID_MINT_NFT_PAYLOAD', '`metadataUri` should be a valid url')))
});
var updateNFTSchema = joi__default['default'].object({
  mint_address: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_NFT_PAYLOAD', toErrorMessage('INVALID_UPDATE_NFT_PAYLOAD', '`mint_address` should be a valid mint address'))),
  name: joi__default['default'].string().optional().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_NFT_PAYLOAD', toErrorMessage('INVALID_UPDATE_NFT_PAYLOAD', '`name` should be a valid string'))),
  symbol: joi__default['default'].string().optional().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_NFT_PAYLOAD', toErrorMessage('INVALID_UPDATE_NFT_PAYLOAD', '`symbol` should be a valid string of less than 10 characters'))),
  update_authority: joi__default['default'].string().optional().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_NFT_PAYLOAD', toErrorMessage('INVALID_UPDATE_NFT_PAYLOAD', '`update_authority` should be a valid publick key string'))),
  seller_fee_basis_points: joi__default['default'].number().min(0).max(10000).optional().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_NFT_PAYLOAD', toErrorMessage('INVALID_UPDATE_NFT_PAYLOAD', '`seller_fee_basis_points` should be a valid number between 0 and 10000'))),
  url: joi__default['default'].string().uri().optional().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_NFT_PAYLOAD', toErrorMessage('INVALID_UPDATE_NFT_PAYLOAD', '`metadataUri` should be a valid url'))),
  confirmation: joi__default['default'].string().valid('confirmed', 'finalized').optional().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_NFT_PAYLOAD', toErrorMessage('INVALID_UPDATE_NFT_PAYLOAD', '`commitment` should be one of "confirmed" or "finalized"')))
});
var transferNFTSchema = joi__default['default'].object({
  mint_address: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_TRANSFER_NFT_PAYLOAD', toErrorMessage('INVALID_TRANSFER_NFT_PAYLOAD', '`mintAddress` should be a valid mint address'))),
  to_wallet_address: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_TRANSFER_NFT_PAYLOAD', toErrorMessage('INVALID_TRANSFER_NFT_PAYLOAD', '`recipientAddress` should be a valid wallet address')))
});
var fetchNFTsByMintAddressesSchema = joi__default['default'].object({
  mint_addresses: joi__default['default'].array().items(joi__default['default'].string()).required().error(MirrorWorldSDKError["new"]('INVALID_FETCH_NFT_BY_MINT_ADDRESSES_PAYLOAD', toErrorMessage('INVALID_FETCH_NFT_BY_MINT_ADDRESSES_PAYLOAD', '`mintAddresses` should be a valid array of mint addresses'))),
  limit: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_FETCH_NFT_BY_MINT_ADDRESSES_PAYLOAD', toErrorMessage('INVALID_FETCH_NFT_BY_MINT_ADDRESSES_PAYLOAD', '`limit` should be a integer'))),
  offset: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_FETCH_NFT_BY_MINT_ADDRESSES_PAYLOAD', toErrorMessage('INVALID_FETCH_NFT_BY_MINT_ADDRESSES_PAYLOAD', '`offset` should be a integer')))
});
var fetchNFTsByCreatorAddressesSchema = joi__default['default'].object({
  creators: joi__default['default'].array().items(joi__default['default'].string()).required().error(MirrorWorldSDKError["new"]('INVALID_FETCH_NFT_BY_CREATOR_ADDRESSES_PAYLOAD', toErrorMessage('INVALID_FETCH_NFT_BY_CREATOR_ADDRESSES_PAYLOAD', '`creators` should be a valid array of creator addresses'))),
  limit: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_FETCH_NFT_BY_CREATOR_ADDRESSES_PAYLOAD', toErrorMessage('INVALID_FETCH_NFT_BY_CREATOR_ADDRESSES_PAYLOAD', '`limit` should be a integer'))),
  offset: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_FETCH_NFT_BY_CREATOR_ADDRESSES_PAYLOAD', toErrorMessage('INVALID_FETCH_NFT_BY_CREATOR_ADDRESSES_PAYLOAD', '`offset` should be a integer')))
});
var fetchNFTsByUpdateAuthoritiesSchema = joi__default['default'].object({
  update_authorities: joi__default['default'].array().items(joi__default['default'].string()).required().error(MirrorWorldSDKError["new"]('INVALID_FETCH_NFT_BY_UPDATE_AUTHORITIES_PAYLOAD', toErrorMessage('INVALID_FETCH_NFT_BY_UPDATE_AUTHORITIES_PAYLOAD', '`udpateAuthorities` should be a valid array of update authority addresses'))),
  limit: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_FETCH_NFT_BY_UPDATE_AUTHORITIES_PAYLOAD', toErrorMessage('INVALID_FETCH_NFT_BY_UPDATE_AUTHORITIES_PAYLOAD', '`limit` should be a integer'))),
  offset: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_FETCH_NFT_BY_UPDATE_AUTHORITIES_PAYLOAD', toErrorMessage('INVALID_FETCH_NFT_BY_UPDATE_AUTHORITIES_PAYLOAD', '`offset` should be a integer')))
});
var fetchNFTsByOwnerAddressesSchema = joi__default['default'].object({
  owners: joi__default['default'].array().items(joi__default['default'].string()).required().error(MirrorWorldSDKError["new"]('INVALID_FETCH_NFT_BY_OWNERS_PAYLOAD', toErrorMessage('INVALID_FETCH_NFT_BY_OWNERS_PAYLOAD', '`owners` should be a valid array of owner addresses'))),
  limit: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_FETCH_NFT_BY_UPDATE_AUTHORITIES_PAYLOAD', toErrorMessage('INVALID_FETCH_NFT_BY_UPDATE_AUTHORITIES_PAYLOAD', '`limit` should be a integer'))),
  offset: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_FETCH_NFT_BY_UPDATE_AUTHORITIES_PAYLOAD', toErrorMessage('INVALID_FETCH_NFT_BY_UPDATE_AUTHORITIES_PAYLOAD', '`offset` should be a integer')))
});

var listNFTSchema = joi__default['default'].object({
  mint_address: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_LIST_NFT_PAYLOAD', toErrorMessage('INVALID_LIST_NFT_PAYLOAD', '`mintAddress` should be a valid mint address'))),
  price: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_LIST_NFT_PAYLOAD', toErrorMessage('INVALID_LIST_NFT_PAYLOAD', '`price` should be a valid number'))),
  auction_house: joi__default['default'].string().optional().error(MirrorWorldSDKError["new"]('INVALID_LIST_NFT_PAYLOAD', toErrorMessage('INVALID_LIST_NFT_PAYLOAD', '`auction_house` should be a valid auction_house address')))
});
var buyNFTSchema = joi__default['default'].object({
  mint_address: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_PURCHASE_NFT_PAYLOAD', toErrorMessage('INVALID_PURCHASE_NFT_PAYLOAD', '`mintAddress` should be a valid mint address'))),
  price: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_PURCHASE_NFT_PAYLOAD', toErrorMessage('INVALID_PURCHASE_NFT_PAYLOAD', '`price` should be a valid number'))),
  auction_house: joi__default['default'].string().optional().error(MirrorWorldSDKError["new"]('INVALID_PURCHASE_NFT_PAYLOAD', toErrorMessage('INVALID_PURCHASE_NFT_PAYLOAD', '`auction_house` should be a valid auction_house address')))
});
joi__default['default'].object({
  mint_address: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_LISTING_NFT_PAYLOAD', toErrorMessage('INVALID_UPDATE_LISTING_NFT_PAYLOAD', '`mintAddress` should be a valid mint address'))),
  price: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_LISTING_NFT_PAYLOAD', toErrorMessage('INVALID_UPDATE_LISTING_NFT_PAYLOAD', '`price` should be a valid number'))),
  auction_house: joi__default['default'].string().optional().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_LISTING_NFT_PAYLOAD', toErrorMessage('INVALID_UPDATE_LISTING_NFT_PAYLOAD', '`auction_house` should be a valid auction_house address')))
});
var cancelNFTListingSchema = joi__default['default'].object({
  mint_address: joi__default['default'].string().required().error(MirrorWorldSDKError["new"]('INVALID_CANCEL_LISTING_NFT_PAYLOAD', toErrorMessage('INVALID_CANCEL_LISTING_NFT_PAYLOAD', '`mintAddress` should be a valid mint address'))),
  price: joi__default['default'].number().required().error(MirrorWorldSDKError["new"]('INVALID_CANCEL_LISTING_NFT_PAYLOAD', toErrorMessage('INVALID_CANCEL_LISTING_NFT_PAYLOAD', '`price` should be a valid number'))),
  auction_house: joi__default['default'].string().optional().error(MirrorWorldSDKError["new"]('INVALID_CANCEL_LISTING_NFT_PAYLOAD', toErrorMessage('INVALID_CANCEL_LISTING_NFT_PAYLOAD', '`auction_house` should be a valid auction_house address')))
});
var strorefrontConfigValidator = function strorefrontConfigValidator(error) {
  return joi__default['default'].object({
    name: joi__default['default'].string().required().error(MirrorWorldSDKError["new"](error, toErrorMessage(error, ' The `storefront.name` should be a valid string.'))),
    subdomain: joi__default['default'].string().required().error(MirrorWorldSDKError["new"](error, toErrorMessage(error, ' The `storefront.subdomain` should be a valid string.'))),
    description: joi__default['default'].string().required().error(MirrorWorldSDKError["new"](error, toErrorMessage(error, ' The `storefront.description` should be a valid string.'))),
    logo: joi__default['default'].string().uri().required().error(MirrorWorldSDKError["new"](error, toErrorMessage(error, ' The `storefront.logo` should be a valid URL.'))),
    banner: joi__default['default'].string().uri().required().error(MirrorWorldSDKError["new"](error, toErrorMessage(error, ' The `storefront.banner` should be a valid URL.')))
  });
};
var createMarketplaceSchema = joi__default['default'].object({
  treasury_mint: joi__default['default'].string().optional().error(MirrorWorldSDKError["new"]('INVALID_CREATE_MARKETPLACE_PAYLOAD', toErrorMessage('INVALID_CREATE_MARKETPLACE_PAYLOAD', '`treasury_mint` should be a valid SPL mint address'))),
  seller_fee_basis_points: joi__default['default'].number().min(0).max(10000).required().error(MirrorWorldSDKError["new"]('INVALID_CREATE_MARKETPLACE_PAYLOAD', toErrorMessage('INVALID_CREATE_MARKETPLACE_PAYLOAD', '`seller_fee_basis_points` should be a valid number between 0 and 10000'))),
  collections: joi__default['default'].array().optional().items(joi__default['default'].string()).error(MirrorWorldSDKError["new"]('INVALID_CREATE_MARKETPLACE_PAYLOAD', toErrorMessage('INVALID_CREATE_MARKETPLACE_PAYLOAD', '`collections` should be a valid array of SPL mint addresses'))),
...
var updateMarketplaceSchema = joi__default['default'].object({
  treasury_mint: joi__default['default'].string().optional().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_MARKETPLACE_PAYLOAD', toErrorMessage('INVALID_UPDATE_MARKETPLACE_PAYLOAD', '`treasury_mint` should be a valid SPL mint address'))),
  seller_fee_basis_points: joi__default['default'].number().min(0).max(10000).required().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_MARKETPLACE_PAYLOAD', toErrorMessage('INVALID_UPDATE_MARKETPLACE_PAYLOAD', '`seller_fee_basis_points` should be a valid number between 0 and 10000'))),
  collections: joi__default['default'].array().optional().items(joi__default['default'].string()).error(MirrorWorldSDKError["new"]('INVALID_UPDATE_MARKETPLACE_PAYLOAD', toErrorMessage('INVALID_UPDATE_MARKETPLACE_PAYLOAD', '`collections` should be a valid array of SPL mint addresses'))),
  ...
  new_authority: joi__default['default'].string().optional().error(MirrorWorldSDKError["new"]('INVALID_UPDATE_MARKETPLACE_PAYLOAD', toErrorMessage('INVALID_UPDATE_MARKETPLACE_PAYLOAD', '`new_authority` should be a valid Solana address')))
});
...
var createActionSchema = joi__default['default'].object({
  type: (_joi$string$required = joi__default['default'].string().required()).valid.apply(_joi$string$required, _toConsumableArray(validActions)).error(MirrorWorldSDKError["new"]('INVALID_CREATE_ACTION_PAYLOAD', toErrorMessage('INVALID_CREATE_ACTION_PAYLOAD', '`type` should be a one of: ' + ['mint_nft', 'update_nft', 'transfer_sol', 'transfer_spl_token', 'create_collection', 'create_sub_collection', 'list_nft', 'buy_nft', 'cancel_listing', 'update_listing', 'transfer_nft', 'interaction', 'create_marketplace', 'update_marketplace'].join(', ')))),
  value: joi__default['default'].number().optional().error(MirrorWorldSDKError["new"]('INVALID_CREATE_ACTION_PAYLOAD', toErrorMessage('INVALID_CREATE_ACTION_PAYLOAD', '`value` should be a valid number'))),
  params: joi__default['default'].object().optional().error(MirrorWorldSDKError["new"]('INVALID_CREATE_ACTION_PAYLOAD', toErrorMessage('INVALID_CREATE_ACTION_PAYLOAD', '`params` should be a valid object')))
});
...
var MirrorWorld = /*#__PURE__*/function () {
  ...
  function MirrorWorld(options) {
    ...
    _defineProperty(this, "getApprovalToken", function (payload) {
      return new Promise( /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee2(resolve, reject) {
              ...
              switch (_context2.prev = _context2.next) {
                ...
                case 13:
                  ...
                  window.addEventListener('message', /*#__PURE__*/function () {
                    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee(event) {
                      var _event$data;
                      ...
                      return _regeneratorRuntime__default['default'].wrap(function _callee$(_context) {
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              _context.next = 2;
                              return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bson')); });
    ...
    var _result$value = _result.value,
        ...
        env = _result$value$env === void 0 ? exports.ClusterEnvironment.mainnet : _result$value$env,
    ...
    this.on('ready', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee3() {
  ...
  _createClass(MirrorWorld, [{
    ...
    key: "network",
    get: function get() {
      return this._env === exports.ClusterEnvironment.mainnet ? 'mainnet' : this._env === exports.ClusterEnvironment.testnet ? 'devnet' : 'devnet';
    }
    /** Get current user */
    ...
    value: function defineInternalListeners() {
      this.on('update:user', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee4() {
    ...
    key: "loginWithEmail",
    value: function () {
      var _loginWithEmail = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee5(credentials) {
    ...
    key: "logout",
    value: function () {
      var _logout = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee6() {
    ...
    value: function () {
      var _refreshAccessToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee7(refreshToken) {
    ...
    key: "fetchUser",
    value: function () {
      var _fetchUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee8() {
        var response, user;
    ...
    key: "openWallet",
    value: function () {
      var _openWallet = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee9(path) {
    ...
    value: function login() {
      ...
      return new Promise( /*#__PURE__*/function () {
        var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee11(resolve, reject) {
          var authWindow;
            ...
            while (1) {
              switch (_context11.prev = _context11.next) {
                ...
                case 3:
                  ...
                  window.addEventListener('message', /*#__PURE__*/function () {
                    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee10(event) {
                      var _event$data3;
     ...
     */
    function () {
      var _getNftDetails = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee12(mintAddress) {
        var response;
    ...
    key: "getTokens",
    value: function () {
      var _getTokens = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee13() {
        var response, tokens;
    ...
    key: "getTransactions",
    value: function () {
      var _getTransactions = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee14() {
    ...
    key: "getNFTs",
    value: function () {
      var _getNFTs = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee15(payload) {
        var nfts;
    ...
    value: function () {
      var _getNFTsOwnedByAddress = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee16(address, payload) {
    ...
    value: function () {
      var _transferSPLToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee17(payload) {
    ...
    key: "transferSOL",
    value: function () {
      var _transferSOL = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee18(payload) {
    ...
    value: function () {
      var _createVerifiedCollection = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee19(payload) {
        var commitment,
            result,
    ...
    key: "mintNFT",
    value: function () {
      var _mintNFT = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee20(payload) {
    ...
    key: "updateNFT",
    value: function () {
      var _updateNFT = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee21(payload) {
        var commitment,
            result,
    ...
    key: "listNFT",
    value: function () {
      var _listNFT = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee22(payload) {
    ...
    key: "buyNFT",
    value: function () {
      var _buyNFT = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee23(payload) {
    ...
    value: function () {
      var _updateNFTListing = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee24(payload) {
    ...
    value: function () {
      var _cancelNFTListing = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee25(payload) {
    ...
    key: "transferNFT",
    value: function () {
      var _transferNFT = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee26(payload) {
    ...
    value: function () {
      var _fetchNFTsByMintAddresses = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee27(payload) {
    ...
    value: function () {
      var _fetchNFTsByCreatorAddresses = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee28(payload) {
    ...
    value: function () {
      var _fetchNFTsByUpdateAuthorities = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee29(payload) {
    ...
    value: function () {
      var _fetchNFTsByOwnerAddresses = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee30(payload) {
    ...
    value: function () {
      var _fetchNFTMarketplaceActivity = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee31(mintAddress) {
        var _response$data5;
    ...
    value: function () {
      var _createMarketplace = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee32(payload) {
    ...
    value: function () {
      var _updateMarketplace = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee33(payload) {
    ...
    value: function () {
      var _queryMarketplaces = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee34(query) {
        var pagination,
            params,
            response,
            _args34 = arguments;
          ...
          while (1) {
            switch (_context34.prev = _context34.next) {
              case 0:
                ...
                params = qs__default['default'].stringify(_objectSpread(_objectSpread({}, query), pagination));
                _context34.next = 4;
...
exports.MirrorWorld = MirrorWorld;
